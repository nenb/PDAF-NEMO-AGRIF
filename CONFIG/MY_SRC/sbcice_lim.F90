...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: sbcice_lim.F90 6399 2016-03-22 17:17:23Z clem $
...
!!gm   remark, the ocean-ice stress is not saved in ice diag call above .....  find a solution!!!
   ...
   SUBROUTINE sbc_lim_init
      ...
      WRITE(fname,'(a)') 'output_'//TRIM(ensstr)//'.namelist.ice'
      IF(lwm) CALL ctl_opn( numoni, fname, 'UNKNOWN', 'FORMATTED', 'SEQUENTIAL', -1, numout, lwp, 1 )
#else
