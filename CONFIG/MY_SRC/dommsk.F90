...
!!gm end
      ...
      DO jk = 1, jpk
         ...
         IF( .NOT. AGRIF_Root() ) THEN
            IF ((nbondi ==  1).OR.(nbondi == 2)) fmask(nlci-1 , :     ,jk) = 0._wp      ! east
            IF ((nbondi == -1).OR.(nbondi == 2)) fmask(1      , :     ,jk) = 0._wp      ! west
            IF ((nbondj ==  1).OR.(nbondj == 2)) fmask(:      ,nlcj-1 ,jk) = 0._wp      ! north
            IF ((nbondj == -1).OR.(nbondj == 2)) fmask(:      ,1      ,jk) = 0._wp      ! south
         ENDIF
