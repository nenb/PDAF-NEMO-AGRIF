...
!MMS:{
   CHARACTER(len=32),PUBLIC ::   cn_bfrfile  = "bfr_coef.nc"   !: namelist filename parameter for bottom firction enhancement mask
!:MMS}
   !! * Substitutions
...
#  include "domzgr_substitute.h90"
   ...
   !! $Id: zdfbfr.F90 5332 2015-06-01 16:59:09Z mathiot $
...
!                     &  rn_bfrien, rn_tfrien, ln_bfrimp, ln_loglayer
      NAMELIST/nambfr/ nn_bfr, rn_bfri1, rn_bfri2, rn_bfri2_max, rn_bfeb2, rn_bfrz0, ln_bfr2d, &
                    &          rn_tfri1, rn_tfri2, rn_tfri2_max, rn_tfeb2, rn_tfrz0, ln_tfr2d, &
                    &  rn_bfrien, rn_tfrien, ln_bfrimp, ln_loglayer, cn_bfrfile
!:MMS}
      !!----------------------------------------------------------------------
      !
...
!           CALL iom_open('bfr_coef.nc',inum)
            CALL iom_open( TRIM(cn_bfrfile) , inum )
!:MMS}
