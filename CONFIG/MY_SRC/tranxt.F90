...
#  include "domzgr_substitute.h90"
   ...
   !! $Id: tranxt.F90 5656 2015-07-31 08:55:56Z timgraham $
...
CONTAINS
   ...
   SUBROUTINE tra_nxt( kt )
      ...
      ! 
!FUS start: reverse order agrif_tra and lbc_lnk (suggested by JChanut)
!
!#if defined key_agrif
...
!
      ...
      CALL Agrif_tra                     ! AGRIF zoom boundaries
#endif
!FUS end: reverse order agrif_tra and lbc_lnk (suggested by JChanut)
