...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: domzgr.F90 6204 2016-01-04 13:47:06Z cetlod $
...
!      NAMELIST/namzgr/ ln_zco, ln_zps, ln_sco, ln_isfcav
      NAMELIST/namzgr/ ln_zco, ln_zps, ln_sco, ln_isfcav, cn_batmeter, cn_batlevel
!:MMS}
      !!----------------------------------------------------------------------
      !
...
!            CALL iom_open( 'bathy_level.nc', inum )   
            CALL iom_open( TRIM(cn_batlevel), inum ) 
!:MMS}
...
!            CALL iom_open( 'bathy_meter.nc', inum )  
            CALL iom_open( TRIM(cn_batmeter), inum )  
!:MMS}
            IF ( ln_isfcav ) THEN
