...
!MMS:{
   CHARACTER(lc),PUBLIC ::   cn_coordfile  = "coordinates.nc"   !: horizontal grid file 
   CHARACTER(lc),PUBLIC ::   cn_batmeter   = "bathy_meter.nc"   !: bathymetry file name (meter) 
   CHARACTER(lc),PUBLIC ::   cn_batlevel   = "bathy_level.nc"   !: bathymetry file name (levels) 
!:MMS}
   ...
   !! $Id: dom_oce.F90 5123 2015-03-04 16:06:03Z clem $ 
